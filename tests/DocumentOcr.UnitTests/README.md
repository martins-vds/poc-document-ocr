...
This project contains the **unit tests** for the Document OCR solution. For
the integration test project (WebApp WAF + bUnit pages + Azurite/Cosmos
round-trips) see [../DocumentOcr.IntegrationTests/](../DocumentOcr.IntegrationTests/).
The two projects are described together in [../README.md](../README.md).
